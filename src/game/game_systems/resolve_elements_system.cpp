...
static ElementCombo g_element_combinations[] = {
    ...
    {{ELE_WATER, ELE_FIRE, ELE_NONE}, {PROJECTILE_JET_BOMB, 200, 1.8f, 35, TEXTURE_BOX_FIRE_WATER}},
    {{ELE_EARTH, ELE_FIRE, ELE_NONE}, {PROJECTILE_BOMB, 200, 0.4f, 12, TEXTURE_BOX_FIRE_EARTH}},
    {{ELE_WIND, ELE_FIRE, ELE_NONE}, {PROJECTILE_AREA_GUST, 100, 2.5f, 0, TEXTURE_BOX_FIRE_WIND}},
    ...
    {{ELE_WATER, ELE_WIND, ELE_NONE}, {PROJECTILE_ICE_SHARD,250, 1.5f, 45, TEXTURE_BOX_WATER_WIND}},
