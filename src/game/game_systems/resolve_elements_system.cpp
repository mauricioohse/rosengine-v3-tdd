...
static ElementCombo g_element_combinations[] = {
    ...
    {{ELE_FIRE, ELE_NONE, ELE_NONE},     {PROJECTILE_BOMB,       125, 2.f,   40,  TEXTURE_BOX,         {"Fire tower",      "Lobbed Explosive Bomb", "Low damage (40)",     "Medium attack speed"}}},
    {{ELE_WATER, ELE_NONE, ELE_NONE},    {PROJECTILE_JET,        250, 3.0f,  150, TEXTURE_BOX_BLUE,    {"Water tower",     "Targeted Jet",          "Medium damage (150)", "Slow attack speed"}}},
    {{ELE_EARTH, ELE_NONE, ELE_NONE},    {PROJECTILE_PELLET,     150, 0.5f,  8,   TEXTURE_BOX_EARTH,   {"Earth tower",     "Targeted Pellet",       "Low damage (8)",      "Fast attack speed"}}},
    ...
    {{ELE_EARTH, ELE_WIND, ELE_NONE},    {PROJECTILE_PELLET,              150, 0.3f,  15,  TEXTURE_BOX_EARTH_WIND,   {"Earth Wind tower",    "Targeted Pellet",              "Low damage (15)",     "Fast attack speed"}}}, // note: no difference to only earth tower (except numbers)
