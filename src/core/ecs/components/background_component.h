...
struct BackgroundComponent : Component<BackgroundComponent> {
    ...
    static void Add(EntityID entity, float parallax) {
        ComponentManager<BackgroundComponent>::Add(entity, parallax);
    }
